...
class ByggRFormpipeProxyMapper2Test {

    private static final String SUBMISSION_AGREEMENT_ID = "someSubmissionAgreementId";

    private final ByggRFormpipeProxyMapper2 mapper = new ByggRFormpipeProxyMapper2(SUBMISSION_AGREEMENT_ID);
    ...
    void test_mapRequest() {
        ...
        var archiveRequest = new ByggRArchiveRequest2();
        ...
        assertThat(importRequest.getMetadataXml()).isEqualTo("someMetadata");
