...
public class Attachment {
    ...
    @NotBlank
    @Pattern(regexp = "^\\.(bmp|gif|tif|tiff|jpeg|jpg|png|htm|html|pdf|rtf|doc|docx|txt|xls|xlsx|odt|ods|pptx|ppt)$", message = "extension must be valid. Must match regex: {regexp}")
    @Schema(example = ".pdf")
